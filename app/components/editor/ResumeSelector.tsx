...
import { SavedResume, ResumeData } from "@/app/types/resume";
...
export function ResumeSelector({ resumes, activeId, onSwitch, onCreate, onDuplicate, onDelete, onRename, onImport }: Props) {
  ...
  function handleExport() {
    ...
    const json = JSON.stringify(active.data, null, 2);
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden">
          ...
          <div className="border-t border-gray-100 p-2 flex flex-col gap-0.5">
            ...
            <button type="button" onClick={() => fileInputRef.current?.click()}
              className="w-full text-left text-xs text-gray-500 hover:text-gray-700 font-medium px-2 py-1.5 rounded hover:bg-gray-50 transition-colors flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
